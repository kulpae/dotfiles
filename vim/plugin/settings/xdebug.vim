...
map <F7> :python debugger_context()<cr>
map <F8> :python debugger_property()<cr>
map <F7> :python debugger_watch_input("context_get")<cr>A<cr>
map <F8> :python debugger_watch_input("property_get", '<cword>')<cr>A<cr>
